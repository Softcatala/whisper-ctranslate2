...
update-e2e-tests:
	...
	$(E2E_COMMAND) e2e-tests/gossos.mp3 --device cpu --compute_type float32 --vad_filter True --vad_min_speech_duration_ms 2000 --vad_max_speech_duration_s 50000 --output_dir e2e-tests/ref-small-transcribe-vad/
